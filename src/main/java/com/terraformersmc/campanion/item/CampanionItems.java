...
public class CampanionItems {
	...
	public static final SpearItem NETHERITE_SPEAR = add("netherite_spear", new SpearItem(ToolMaterials.NETHERITE, 2.0F, -2.8F, () -> CampanionEntities.NETHERITE_SPEAR, new Item.Settings().group(ItemGroup.COMBAT).fireproof()));
	...
	public static final TentItem SMALL_UNBUILT_TENT = add("small_unbuilt_tent", new TentItem(new Item.Settings().group(ItemGroup.TOOLS).maxCount(1), "small"));
	public static final TentItem LARGE_UNBUILT_TENT = add("large_unbuilt_tent", new TentItem(new Item.Settings().group(ItemGroup.TOOLS).maxCount(1), "large"));
