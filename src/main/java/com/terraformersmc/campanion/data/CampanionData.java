...
public class CampanionData {
	...
	private static class ItemTags extends Dossier.ItemTagsDossier {
		...
		protected void addItemTags() {
			this.fromBlock(CampanionBlockTags.LAWN_CHAIRS, CampanionItemTags.LAWN_CHAIRS);
			this.fromBlock(CampanionBlockTags.TENT_SIDES, CampanionItemTags.TENT_SIDES);
			this.fromBlock(CampanionBlockTags.TENT_TOPS, CampanionItemTags.TENT_TOPS);
			this.fromBlock(CampanionBlockTags.TOPPED_TENT_POLES, CampanionItemTags.TOPPED_TENT_POLES);
			this.fromBlock(CampanionBlockTags.FLAT_TENT_TOPS, CampanionItemTags.FLAT_TENT_TOPS);
			this.fromBlock(CampanionBlockTags.TENT_POLES, CampanionItemTags.TENT_POLES);
