...
public class CampanionData implements DossierProvider {
	...
	private static class CampanionRecipesGenerator extends RecipesDossier {
		...
		protected void addRecipes(Consumer<RecipeJsonProvider> exporter) {
			...
			ShapedRecipeJsonFactory.create(CampanionItems.STONE_SPEAR).input('#', CampanionItems.WOODEN_ROD).input('X', net.minecraft.tag.ItemTags.STONE_TOOL_MATERIALS).pattern("X").pattern("#").criterion("has_stone", this.conditionsFrom(Blocks.COBBLESTONE)).offerTo(exporter);
